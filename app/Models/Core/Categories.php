...
class Categories extends Model
{
    ...
    public function insert($uploadImage,$date_added,$parent_id,$uploadIcon,$categories_status,$uploadImage1,$uploadIcon1){
        $categories = DB::table('categories')->insertGetId([
            'categories_image'   =>   $uploadImage,
            'categories_image1'   =>   $uploadImage1,
            'created_at'		 =>   $date_added,
            'parent_id'		 	 =>   $parent_id,
            'categories_icon'	 =>	  $uploadIcon,
            'categories_icon1'	 =>	  $uploadIcon1,
    ...
    public function updaterecord($categories_id,$uploadImage,$uploadIcon,$last_modified,$parent_id,$slug,$categories_status,$uploadImage1,$uploadIcon1){
    ...
    public function editsubcategory($request){
        $editSubCategory = DB::table('categories')
            ->leftJoin('image_categories as categoryTable','categoryTable.image_id', '=', 'categories.categories_image')
            ->leftJoin('image_categories as categoryTable1','categoryTable1.image_id', '=', 'categories.categories_image1')
            ->leftJoin('image_categories as iconTable','iconTable.image_id', '=', 'categories.categories_icon')
            ->leftJoin('image_categories as iconTable1','iconTable1.image_id', '=', 'categories.categories_icon1')

            ->select('categories.categories_id as id', 'categories.categories_image as image','categories.categories_image1 as image1', 'categories.categories_icon as icon','categories.categories_icon1 as icon1', 'categories.created_at as date_added', 'categories.updated_at as last_modified',
            'categories.categories_slug as slug', 'categories.categories_status  as categories_status', 'categories.parent_id as parent_id','categoryTable.path as imgpath','categoryTable1.path as imgpath1','iconTable.path as iconpath','iconTable1.path as iconpath1')
            ->where('categories.categories_id', $request->id)->get();
