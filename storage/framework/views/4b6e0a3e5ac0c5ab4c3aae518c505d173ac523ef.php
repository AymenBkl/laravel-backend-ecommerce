...
<script src="<?php echo asset('admin/bootstrap/js/bootstrap.min.js'); ?>"></script>
<script src="<?php echo asset('admin/plugins/select2/select2.full.min.js'); ?>"></script>

<!-- InputMask -->
<script src="<?php echo asset('admin/plugins/input-mask/jquery.inputmask.js'); ?>"></script>
<script src="<?php echo asset('admin/plugins/input-mask/jquery.inputmask.date.extensions.js'); ?>"></script>
<script src="<?php echo asset('admin/plugins/input-mask/jquery.inputmask.extensions.js'); ?>"></script>
<script src="<?php echo asset('admin/js/jquery.validate.js'); ?>"></script>
<!-- date-range-picker -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>
<script src="<?php echo asset('admin/plugins/daterangepicker/daterangepicker.js'); ?>"></script>
<script src="<?php echo asset('admin/js/dropzone.js'); ?>"></script>
<script src="<?php echo asset('admin/js/image-picker.js'); ?>"></script>
<script src="<?php echo asset('admin/js/image-picker.min.js'); ?>"></script>

<script src="<?php echo asset('admin/js/jquery.fancybox.min.js'); ?>"></script>

<!-- bootstrap datepicker -->
<script src="<?php echo asset('admin/plugins/datepicker/bootstrap-datepicker.js'); ?>"></script>

<!-- bootstrap color picker -->
<script src="<?php echo asset('admin/plugins/colorpicker/bootstrap-colorpicker.min.js'); ?>"></script>
<!-- bootstrap time picker -->
<script src="<?php echo asset('admin/plugins/timepicker/bootstrap-timepicker.min.js'); ?>"></script>
<!-- SlimScroll 1.3.0 -->
<script src="<?php echo asset('admin/plugins/slimScroll/jquery.slimscroll.min.js'); ?>"></script>
<!-- iCheck 1.0.1 -->
<script src="<?php echo asset('admin/plugins/iCheck/icheck.min.js'); ?>"></script>
<!-- FastClick -->
<script src="<?php echo asset('admin/plugins/fastclick/fastclick.js'); ?>"></script>
<!-- AdminLTE App -->
<script src="<?php echo asset('admin/dist/js/app.min.js'); ?>"></script>
<script src="<?php echo e(url('admin/js/clipboard.min.js')); ?>"></script>
...
<script src="<?php echo asset('admin/js/demo.js'); ?>"></script>

<script src="<?php echo asset('admin/plugins/chartjs/Chart.min.js'); ?>"></script>
<script src="<?php echo asset('admin/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js'); ?>"></script>
<script src="<?php echo asset('admin/plugins/jvectormap/jquery-jvectormap-world-mill-en.js'); ?>"></script>
<script src="<?php echo asset('admin/plugins/sparkline/jquery.sparkline.min.js'); ?>"></script>
...
$("img").click(function() {
  ...
  $("img").click(function() {
    ...
    $(".hover").each(function() {
    //jQuery.each('.hover', function() {
      id.push(jQuery(this).attr("image_id1"));
...
$(document).on('click', '#updateAddress', function(e){
  ...
  $(document).on('click', '#deleteModelId', function(){
	...
	$(document).on('click', '.default_method', function(){
		...
		$.ajax({
			url: '<?php echo e(URL::to("admin/shippingmethods/defaultShippingMethod")); ?>',
			type: "POST",
...
$("#AddImage").click(function(){ window.location.href = '<?php echo e(url("admin/media/addimages")); ?>'; });

$(document).on('click','#selected', function(){
	var image_src = $('#Modalmanufactured').find(".thumbnail.selected").children("img").attr('src');
...
$(document).on('click','#selected1', function(){
	var image_src = $('#Modalmanufactured1').find(".thumbnail.selected").children("img").attr('src');
	if(image_src != undefined){
		$('#selectedthumbnail1').html('<img src="'+image_src+'" class = "thumbnail" style="max-height: 100px; margin-top: 20px;">');
		$('#selectedthumbnail1').show();
		$('#image-close1').show();
		$('#imageselected1').removeClass('has-error');
		$('#newImage1').removeClass('field-validate');
		$('.thumbnail.selected').removeClass('selected');
	}
});
...
$(document).on('click','#image-close1', function(){
	var oldimage = $('#oldImage').val();
	if(oldimage == undefined){
		$('#newImage1').addClass('field-validate');
	}
...
$(document).on('click','#selectedICONE', function(){
	var image_src = $('#ModalmanufacturedICone').find(".thumbnail.selected").children("img").attr('src');
	if(image_src != undefined){
...
$(document).on('click','#selectedICONE1', function(){
	...
	var image_src = $('#ModalmanufacturedICone1').find(".thumbnail.selected").children("img").attr('src');
...
$(document).on('click', '.deliveryboy-pay-popup', function(){
	...
	$.ajax({
		url: "<?php echo e(url('admin/deliveryboys/withdraw/popupdetail')); ?>",
		type: "GET",
...
$(document).on('click', '.deliveryboy-pay-popup-paid', function(){
	...
	var deliveryboy_id = $(this).attr('deliveryboy_id');
	$.ajax({
		url: "<?php echo e(url('admin/deliveryboys/withdraw/paidpopupdetail')); ?>",
		type: "GET",
		data: '&deliveryboy_id='+deliveryboy_id+'&payment_id='+payment_id,
		success: function (data) {
			$('#vendors-info').html(data);
...
$(document).on('click', '.clear-cache', function(e){
	$('#loader').show();
	$.ajax({
		url: '<?php echo e(URL::to("clear-cache")); ?>',
		type: "get",
		success: function (res) {
			$('#loader').hide();
			myFunction();
...
<?php /**PATH K:\Freelancer\LAravel Ionic Fish\LaravelWebsite&AdminCode\resources\views/admin/common/scripts.blade.php ENDPATH**/ ?>