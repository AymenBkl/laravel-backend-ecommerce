            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-6">
                  ...
                  <div class="small-box bg-teal">
                    <div class="inner">
                      <h3><?php if(!empty($result['commonContent']['currency']->symbol_left)): ?> <?php echo e($result['commonContent']['currency']->symbol_left); ?> <?php endif; ?> <?php echo e($result['profit']); ?> <?php if(!empty($result['commonContent']['currency']->symbol_right)): ?> <?php echo e($result['commonContent']['currency']->symbol_right); ?> <?php endif; ?></h3>
                ...
                <div class="col-lg-4 col-xs-6">
                  ...
                  <div class="small-box bg-yellow">
                    <div class="inner">
                      <h3><?php echo e(count($newCustomers)); ?></h3>
                ...
                <div class="col-lg-4 col-xs-6">
                    ...
                    <div class="small-box bg-light-blue">
                      <div class="inner">
                      <h3><?php echo e($result['compeleted_orders']); ?></h3>
                    ...
                    <div class="nav-tabs-custom">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <p class="notify-colors"><span class="sold-content" data-toggle="tooltip" data-placement="bottom" title="<?php echo e(trans('labels.Apporders')); ?>"></span> <?php echo e(trans('labels.Apporders')); ?>  <span class="purchased-content" data-toggle="tooltip" data-placement="bottom" title="<?php echo e(trans('labels.websiteorders')); ?>"></span><?php echo e(trans('labels.websiteorders')); ?> </p>
                            </div>
                        </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH K:\Freelancer\LAravel Ionic Fish\LaravelWebsite&AdminCode\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>