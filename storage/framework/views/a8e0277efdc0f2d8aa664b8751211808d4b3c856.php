        ...
        <form method="post" action="<?php echo e(route('LaravelInstaller::environmentSaveWizard')); ?>" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group <?php echo e($errors->has('app_name') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="text" name="app_name" id="app_name" value="<?php echo e(old('app_name')); ?>" placeholder="Website Name" />
                ...
                <div class="form-group <?php echo e($errors->has('app_url') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="url" name="app_url" id="app_url" value="<?php echo e(old('app_url')); ?>" placeholder="Website URL" />
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="form-group <?php echo e($errors->has('database_password') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="text" name="database_password" id="database_password" value="<?php echo e(old('database_password')); ?>" placeholder="Database Passwords" />
                ...
                <!-- <div class="block">
                    ...
                    <div class="info">
                        ...
                        <div class="form-group <?php echo e($errors->has('mail_driver') ? ' has-error ' : ''); ?>">
                            ...
                            <input type="text" name="mail_driver" id="mail_driver" value="<?php echo e(old('mail_driver')); ?>" placeholder="Mail Driver e:g. sendmail" />
                        ...
                        <div class="form-group <?php echo e($errors->has('mail_host') ? ' has-error ' : ''); ?>">
                            ...
                            <input type="text" name="mail_host" id="mail_host" value="<?php echo e(old('mail_host')); ?>" placeholder="Mail Host e:g. smtp.gmail.com" />
                        ...
                        <div class="form-group <?php echo e($errors->has('mail_port') ? ' has-error ' : ''); ?>">
                            ...
                            <input type="number" name="mail_port" id="mail_port" value="<?php echo e(old('mail_port')); ?>" placeholder="Mail Port e:g. 587" />
                        ...
                        <div class="form-group <?php echo e($errors->has('mail_username') ? ' has-error ' : ''); ?>">
                            ...
                            <input type="text" name="mail_username" id="mail_username" value="<?php echo e(old('mail_username')); ?>" placeholder="Mail Username / Email Address" />
                        ...
                        <div class="form-group <?php echo e($errors->has('mail_password') ? ' has-error ' : ''); ?>">
                            ...
                            <input type="text" name="mail_password" id="mail_password" value="<?php echo e(old('mail_password')); ?>" placeholder="Mail Password" />
                        ...
                        <div class="form-group <?php echo e($errors->has('mail_encryption') ? ' has-error ' : ''); ?>">
                            ...
                            <input type="text" name="mail_encryption" id="mail_encryption" value="<?php echo e(old('mail_encryption')); ?>" placeholder="Mail Encryption e:g. tls " />
            ...
            <div class="tab" id="tab4content">
                ...
                <div class="form-group <?php echo e($errors->has('password') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="text" name="password" id="password" value="<?php echo e(old('password')); ?>" placeholder="Password" />
                ...
                <div class="form-group <?php echo e($errors->has('password_confirm') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="text" name="password_confirmation" id="password_confirm" value="<?php echo e(old('password_confirmation')); ?>" placeholder="Confirm Password" />
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH K:\Freelancer\LAravel Ionic Fish\LaravelWebsite&AdminCode\resources\views/vendor/installer/environment-wizard.blade.php ENDPATH**/ ?>