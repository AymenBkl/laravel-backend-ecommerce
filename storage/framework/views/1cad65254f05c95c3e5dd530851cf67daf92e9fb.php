                                    ...
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="<?php echo e($result['settings'][121]->name); ?>" id="cardstyle" class="form-control">
                                                        <option <?php if($result['settings'][121]->value == '1'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="1"> <?php echo e(trans('labels.Style1')); ?></option>
                                                        <option <?php if($result['settings'][121]->value == '2'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="2"> <?php echo e(trans('labels.Style2')); ?></option>
                                                        <option <?php if($result['settings'][121]->value == '3'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="3"> <?php echo e(trans('labels.Style3')); ?></option>
                                                        <option <?php if($result['settings'][121]->value == '4'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="4"> <?php echo e(trans('labels.Style4')); ?></option>
                                                        <option <?php if($result['settings'][121]->value == '5'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="5"> <?php echo e(trans('labels.Style5')); ?></option>
                                                        <option <?php if($result['settings'][121]->value == '6'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="6"> <?php echo e(trans('labels.Style6')); ?></option>
                                                        <option <?php if($result['settings'][121]->value == '7'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="7"> <?php echo e(trans('labels.Style 7')); ?></option>
                                                        <option <?php if($result['settings'][121]->value == '8'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="8"> <?php echo e(trans('labels.Style 8')); ?></option>
                                                        <option <?php if($result['settings'][121]->value == '9'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="9"> <?php echo e(trans('labels.Style 9')); ?></option>
                                                        <option <?php if($result['settings'][121]->value == '10'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="10"> <?php echo e(trans('labels.Style 10')); ?></option>

                                                        <option <?php if($result['settings'][121]->value == '11'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="11"> <?php echo e(trans('labels.Style 11')); ?></option>

                                                        <option <?php if($result['settings'][121]->value == '12'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="12"> <?php echo e(trans('labels.Style 12')); ?></option>

                                                        <option <?php if($result['settings'][121]->value == '13'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="13"> <?php echo e(trans('labels.Style 13')); ?></option>

                                                        <option <?php if($result['settings'][121]->value == '14'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="14"> <?php echo e(trans('labels.Style 14')); ?></option>

                                                        <option <?php if($result['settings'][121]->value == '15'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="15"> <?php echo e(trans('labels.Style 15')); ?></option>

                                                        <option <?php if($result['settings'][121]->value == '16'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="16"> <?php echo e(trans('labels.Style 16')); ?></option>

                                                        <option <?php if($result['settings'][121]->value == '17'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="17"> <?php echo e(trans('labels.Style 17')); ?></option>

                                                        <option <?php if($result['settings'][121]->value == '18'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="18"> <?php echo e(trans('labels.Style 18')); ?></option>

                                                        <option <?php if($result['settings'][121]->value == '19'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="19"> <?php echo e(trans('labels.Style 19')); ?></option>

                                                        <option <?php if($result['settings'][121]->value == '20'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="20"> <?php echo e(trans('labels.Style 20')); ?></option>

                                                        <option <?php if($result['settings'][121]->value == '21'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="21"> <?php echo e(trans('labels.Style 21')); ?></option>

                                                        <option <?php if($result['settings'][121]->value == '22'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="22"> <?php echo e(trans('labels.Style 22')); ?></option>
                                                        <option <?php if($result['settings'][121]->value == '23'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="23"> <?php echo e(trans('labels.Style 23')); ?></option>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="<?php echo e($result['settings'][122]->name); ?>" class="form-control">
                                                        <option <?php if($result['settings'][122]->value == '1'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="1"> <?php echo e(trans('labels.Style1')); ?></option>
                                                        <option <?php if($result['settings'][122]->value == '2'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="2"> <?php echo e(trans('labels.Style2')); ?></option>
                                                        <option <?php if($result['settings'][122]->value == '3'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="3"> <?php echo e(trans('labels.Style3')); ?></option>
                                                        <option <?php if($result['settings'][122]->value == '4'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="4"> <?php echo e(trans('labels.Style4')); ?></option>
                                                        <option <?php if($result['settings'][122]->value == '5'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="5"> <?php echo e(trans('labels.Style5')); ?></option>
                                                        <option <?php if($result['settings'][122]->value == '6'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="6"> <?php echo e(trans('labels.Style6')); ?></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="<?php echo e($result['settings'][46]->name); ?>" class="form-control">
                                                        <option <?php if($result['settings'][46]->value == '1'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="1"> <?php echo e(trans('labels.categories1')); ?></option>
                                                        <option <?php if($result['settings'][46]->value == '2'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="2"> <?php echo e(trans('labels.categories2')); ?></option>
                                                        <option <?php if($result['settings'][46]->value == '3'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="3"> <?php echo e(trans('labels.categories3')); ?></option>
                                                        <option <?php if($result['settings'][46]->value == '4'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="4"> <?php echo e(trans('labels.categories4')); ?></option>
                                                        <option <?php if($result['settings'][46]->value == '5'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="5"> <?php echo e(trans('labels.categories5')); ?></option>
                                                        <option <?php if($result['settings'][46]->value == '6'): ?>
                                                                selected
                                                                <?php endif; ?>
                                            ...
                                            <div class="form-group android-hide"id="cart1style" <?php if($result['settings'][121]->value != '1'): ?>
                                                style="display: none"
                                                <?php endif; ?>>
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="<?php echo e($result['settings'][26]->name); ?>" class="form-control">
                                                        <option <?php if($result['settings'][26]->value == '1'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="1"> <?php echo e(trans('labels.Show')); ?></option>
                                                        <option <?php if($result['settings'][26]->value == '0'): ?>
                                                                selected
                                                                <?php endif; ?>
                                            ...
                                            <div class="form-group android-hide">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::text($result['settings'][39]->name,  $result['settings'][39]->value, array('class'=>'form-control', 'id'=>$result['settings'][39]->name)); ?>
                                            ...
                                            <div class="form-group android-hide"  style="display: none">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::text($result['settings'][48]->name,  $result['settings'][48]->value, array('class'=>'form-control', 'id'=>$result['settings'][48]->name)); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="<?php echo e($result['settings'][37]->name); ?>" class="form-control">
                                                        <option <?php if($result['settings'][37]->value == '1'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="1"> <?php echo e(trans('labels.Show')); ?></option>
                                                        <option <?php if($result['settings'][37]->value == '0'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="0"> <?php echo e(trans('labels.Hide')); ?></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="<?php echo e($result['settings'][40]->name); ?>" class="form-control">
                                                        <option <?php if($result['settings'][40]->value == '1'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="1"> <?php echo e(trans('labels.Show')); ?></option>
                                                        <option <?php if($result['settings'][40]->value == '0'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="0"> <?php echo e(trans('labels.Hide')); ?></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::text($result['settings'][22]->name, $result['settings'][22]->value, array('class'=>'form-control', 'id'=>$result['settings'][22]->name)); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <select class="form-control" name="<?php echo e($result['settings'][28]->name); ?>">
                                                        <option value="day" <?php if($result['settings'][28]->value=='day'): ?> selected <?php endif; ?>><?php echo e(trans('labels.Day')); ?></option>
                                                        <option value="month" <?php if($result['settings'][28]->value=='month'): ?> selected <?php endif; ?>><?php echo e(trans('labels.Month')); ?></option>
                                                        <option value="year" <?php if($result['settings'][28]->value=='year'): ?> selected <?php endif; ?>><?php echo e(trans('labels.Year')); ?></option>
                                                    </select>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH K:\Freelancer\LAravel Ionic Fish\LaravelWebsite&AdminCode\resources\views/admin/settings/app/appSettings.blade.php ENDPATH**/ ?>