                                    ...
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::text($result['settings'][70]->name, $result['settings'][70]->value, array('readonly'=>'readonly', 'class'=>'form-control', 'id'=>$result['settings'][70]->name)); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH K:\Freelancer\LAravel Ionic Fish\LaravelWebsite&AdminCode\resources\views/admin/settings/app/applicationApi.blade.php ENDPATH**/ ?>