...
<div class="cart-left">
  ...
  <span class="block">
    <span class="title"><?php echo app('translator')->get('website.MyCart'); ?> </span>       
    <span class="items"><?php echo app('translator')->get('website.item'); ?></span>   
  </span>
</a> 
    ...
    <li>
      ...
      <div class="item-detail">
          ...
          <div class="item-s"><?php echo e($cart_data->customers_basket_quantity); ?> x <?php echo e(Session::get('symbol_left')); ?><?php echo e($cart_data->final_price*session('currency_value')); ?><?php echo e(Session::get('symbol_right')); ?> 
            ...
            <a href="<?php echo e(URL::to('/deleteCart?id='.$cart_data->customers_basket_id)); ?>" class="icon" >
...
<?php endif; ?><?php /**PATH K:\Freelancer\LAravel Ionic Fish\LaravelWebsite&AdminCode\resources\views/web/headers/cartButtons/cartButton1.blade.php ENDPATH**/ ?>