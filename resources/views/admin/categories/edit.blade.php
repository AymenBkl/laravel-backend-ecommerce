                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        {!! Form::hidden('oldImage1', $result['editSubCategory'][0]->image1 , array('id'=>'oldImage1')) !!}
                                        {!! Form::hidden('oldIcon', $result['editSubCategory'][0]->icon , array('id'=>'oldIcon')) !!}
                                        {!! Form::hidden('oldIcon1', $result['editSubCategory'][0]->icon1 , array('id'=>'oldIcon1')) !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                              <span class="help-block " style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.OldImage') }}</span>
                                              <br>
                                              <img src="{{asset($result['editSubCategory'][0]->imgpath1)}}" alt="" width=" 100px">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Icon') }}</label>
                                            <div class="col-sm-10 col-md-4">
                                                {{--{!! Form::file('newIcon1', array('id'=>'newIcon1')) !!}--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.OldImage') }}</span>
                                                <br>
                                                <img src="{{asset($result['editSubCategory'][0]->iconpath1)}}" alt="" width=" 100px">
